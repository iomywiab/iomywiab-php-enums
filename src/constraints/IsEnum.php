 ...
 *
 * File name....: IsEnum.php
 * Class name...: IsEnum.php
...
use iomywiab\iomywiab_php_constraints\constraints\parameterized\AbstractClassnameConstraint;
 ...
 */
class IsEnum extends AbstractClassnameConstraint
{
    /**
    ...
    public static function isValid(string $className, $value, ?string $valueName = null, array &$errors = null): bool
    {
        ...
        if ($definition && $definition->has($value)) {
            return true;
        }
